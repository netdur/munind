...
fn cmd_create(
    ...
    if quantize > 0 {
        ...
        let tq = munind_core::tq::TqIndex::build_from_index(&index_path, quantize)
...
fn cmd_search(
    ...
    if munind_core::tq::TqIndex::is_tq_index(&index_path) {
...
fn cmd_search_tq(
    ...
    let tq = munind_core::tq::TqIndex::load(&index_path).map_err(|e| e.to_string())?;
...
fn cmd_search_mmap(
    ...
    let mut ps = munind_core::common::PropertySet::new();
